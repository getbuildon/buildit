...
export function BackofficeSidebar({ userProfile }: BackofficeSidebarProps) {
  const pathname = usePathname()

  return (
    <aside
      className="flex h-screen w-[220px] shrink-0 flex-col bg-[#111113]"
      style={{ width: BACKOFFICE_SHELL.sidebarWidth }}
    >
      <div
