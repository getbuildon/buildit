            ...
            <div className="flex flex-col gap-8 px-6 pb-8 pt-6">
              <div>
                ...
                <p className="pt-5 text-lg leading-[1.2] tracking-[0.36px] text-[#afb3ba]">
                  Si no sabés qué plan se adapta mejor a tu proyecto, o si
                  BuildOn es para vos, podemos hacerte una demostración y
                  ayudarte a encontrar la mejor forma de implementarlo en tu
                  operación.
                </p>
              </div>
