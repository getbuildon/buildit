            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-[10px] border border-[#afb3ba] bg-white px-3 py-2.5 text-[14px] leading-normal text-[#272a2d] outline-none focus-visible:border-[#ff7433]"
                />
              </div>
